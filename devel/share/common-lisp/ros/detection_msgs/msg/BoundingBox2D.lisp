...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection_msgs-msg:<BoundingBox2D> is deprecated: use detection_msgs-msg:BoundingBox2D instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <BoundingBox2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:center-val is deprecated.  Use detection_msgs-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'size_x-val :lambda-list '(m))
(cl:defmethod size_x-val ((m <BoundingBox2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:size_x-val is deprecated.  Use detection_msgs-msg:size_x instead.")
  (size_x m))

(cl:ensure-generic-function 'size_y-val :lambda-list '(m))
(cl:defmethod size_y-val ((m <BoundingBox2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:size_y-val is deprecated.  Use detection_msgs-msg:size_y instead.")
  (size_y m))
