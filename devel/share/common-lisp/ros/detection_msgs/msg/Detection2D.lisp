...
(cl:defclass <Detection2D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (results
    :reader results
    :initarg :results
    :type detection_msgs-msg:ObjectHypothesisWithPose
    :initform (cl:make-instance 'detection_msgs-msg:ObjectHypothesisWithPose))
   (bbox
    :reader bbox
    :initarg :bbox
    :type detection_msgs-msg:BoundingBox2D
    :initform (cl:make-instance 'detection_msgs-msg:BoundingBox2D))
   (source_img
    :reader source_img
    :initarg :source_img
...
(cl:defmethod cl:initialize-instance :after ((m <Detection2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detection_msgs-msg:<Detection2D> is deprecated: use detection_msgs-msg:Detection2D instead.")))
...
(cl:defmethod results-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:results-val is deprecated.  Use detection_msgs-msg:results instead.")
  (results m))

(cl:ensure-generic-function 'bbox-val :lambda-list '(m))
(cl:defmethod bbox-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:bbox-val is deprecated.  Use detection_msgs-msg:bbox instead.")
  (bbox m))

(cl:ensure-generic-function 'source_img-val :lambda-list '(m))
(cl:defmethod source_img-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detection_msgs-msg:source_img-val is deprecated.  Use detection_msgs-msg:source_img instead.")
  (source_img m))
