...
echo_and_run cd "/home/justin/admp_ur5e_sim_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/justin/admp_ur5e_sim_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/justin/admp_ur5e_sim_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
